...
<body>
    ...
    <div id="inner_banner_main" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="0">
        <div class="main-padding">
            <div class="banner-img-div">
                <img src="assets/img/inner-banner/faq-banner.jpg" alt="" class="img-fluid">
            </div>
        </div>
    </div>
    <!-- INNER BANNER END -->
    ...
    <!-- FAQ SECTION -->
    <section id="faq_main_section" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="200">
        <div class="main-padding">
