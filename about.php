            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12 right-section ps-lg-5 px-3 mt-lg-0 mt-4" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="200">
                    ...
                    <div class="content">
                        ...
                        <p class="main-para">IGCC screens every gemstone using state of the art technologies to determine naturally mined, laboratory grown or simulant orIGCCn. Experienced graduate gemologists conduct further assessment in controlled conditions, detailing relevant gemological characteristics according to the strictest international system.</p>
                        <p class="main-para">Precious stones should only change hands when all parties are confident in the details. Regardless of location or marketplace, an IGCC report is the common language of trust in the gemological world, and an essential part of any transaction.</p>
                    </div>
                    <div class="alternate-btn">Know More</div>
                </div>
            </div>
        </div>
    </section>
