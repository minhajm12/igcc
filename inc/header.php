    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid p-0">
                ...
                <div class="offcanvas-body">
                    <div class="justify-content-end" id="">
                        <ul class="navbar-nav">
                            ...
                            <a class="main-btn d-lg-none d-block" href="verify-report.php" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="0">Verify Report</a>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="d-flex gap-3">
                ...
                <a class="main-btn d-md-block d-none" href="verify-report.php" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="100">verify report</a>
            </div>
